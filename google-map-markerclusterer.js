...
`;
  ...
  static get properties() {
    return {
       ...
       */
      markers: { type: Array, value: function () { return []; }, observer: '_markersChanged' },

      /**
       * If set, the zoom level is set such that all markers (google-map-marker children) are brought into view.
       */
      fitToMarkers: { type: Boolean, value: false, observer: '_fitToMarkersChanged' },

      /**
       * BatchSize specifies the amount of markers that should be processed per run.
       */
      batchSize: { type: Number, value: 2000 },

      /**
       * If set ignores hidden markers when creating the clusters.
       */
      ignoreHidden: { type: Boolean, value: false },

      /**
       * Specifies the size of the grid for each cluster in pixel.
       */
      gridSize: { type: Number, value: 60 },
       ...
       */
      zoomOnClick: { type: Boolean, value: true },
      /**
       * Styles for the google-map-defaulticon element.
       */
      styles: { type: Array, value: null, observer: '_changeStyles' }
    };
  }
